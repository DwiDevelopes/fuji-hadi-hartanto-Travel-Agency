            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="mb-0">123 Travel Street, Jakarta, Indonesia</p>
                    </div>
                </div>
                <div class="d-flex align-items-center mb-4">
                    <div class="d-flex align-items-center justify-content-center bg-primary rounded-circle" style="width: 60px; height: 60px;">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="mb-0">+62 812 2236 2344</p>
                    </div>
                </div>
                <div class="d-flex align-items-center">
                    ...
                    <div class="ms-3">
                        ...
                        <p class="mb-0">fujihadi1997@gmail.com</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="rounded overflow-hidden">
                    <iframe class="position-relative rounded w-100 h-100" 
                        src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3965.7021221468235!2d106.61288807475128!3d-6.302813993686355!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zNsKwMTgnMTAuMSJTIDEwNsKwMzYnNTUuNyJF!5e0!3m2!1sid!2sid!4v1744022391137!5m2!1sid!2sid"
                        frameborder="0" style="min-height: 300px; border:0;" allowfullscreen="" aria-hidden="false"
                        tabindex="0"></iframe>
                </div>
            </div>
            <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
    <form action="php/process_form.php" method="POST" id="reservationForm">
        <div class="row g-3">
            <div class="col-md-6">
