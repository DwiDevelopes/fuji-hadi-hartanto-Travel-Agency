...
<head>
  ...
  <link rel="stylesheet" href="css/wordwide.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css" integrity="sha512-Evv84Mr4kqVGRNSgIGL/F/aIDqQb7xQ2vcrdIwxfjThSH8CSR7PBEakCr51Ck+w+/U6swU2Im1vVX0SVk9ABhg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
 <!-- Google Web Fonts -->
 <link rel="preconnect" href="https://fonts.googleapis.com">
 <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
 <script src = "js/wordwide.js"></script>
 <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css" integrity="sha512-Evv84Mr4kqVGRNSgIGL/F/aIDqQb7xQ2vcrdIwxfjThSH8CSR7PBEakCr51Ck+w+/U6swU2Im1vVX0SVk9ABhg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
 <link
...
<!-- Template Stylesheet -->
<link href="css/style.css" rel="stylesheet">
<div class="wwt-booking-widget col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
  <div class="wwt-header">
    <h3 class="wwt-title" style = "color: #86B817;">Plan Your Journey</h3>
    <p class="wwt-subtitle">Select your travel dates to explore WorldWide Tours</p>
  </div>
  <div class="wwt-image-container">
    <img src="tour/journey.avif" alt="WorldWide Tours" class="wwt-image" loading="lazy" style="border-radius: 8px; width: 100%; height: auto;">
  </div>
  <div class="wwt-cancellation-policy">
    <p class="wwt-cancellation-text">Cancellation policy: Free cancellation within 24 hours of booking.</p>
  
    <form class="wwt-date-form" action="php/process_date.php" method="POST">
    <div class="wwt-form-row">
      <div class="wwt-form-group">
        <label for="wwt-departure-date" class="wwt-form-label">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="wwt-label-icon">
            <path d="M8 2V5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
            <path d="M16 2V5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
            <path d="M3.5 9.09H20.5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
            <path d="M21 8.5V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5Z" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
          </svg>
          Departure Date
        </label>
        <div class="wwt-date-input-container">
          <input type="date" id="wwt-departure-date" name="departure_date" class="wwt-date-input" 
                min="<?php echo date('Y-m-d'); ?>" aria-label="Select departure date" required>
          <span class="wwt-date-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 17H17V19H15V17Z" fill="#86B817"/>
              <path d="M11 17H13V19H11V17Z" fill="#86B817"/>
              <path d="M7 17H9V19H7V17Z" fill="#86B817"/>
              <path d="M8 2V5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
              <path d="M16 2V5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
              <path d="M3.5 9.09H20.5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
              <path d="M21 8.5V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5Z" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
      ...
      <div class="wwt-form-group">
        <label for="wwt-return-date" class="wwt-form-label">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="wwt-label-icon">
            <path d="M8 2V5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
            <path d="M16 2V5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
            <path d="M3.5 9.09H20.5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
        ...
        <div class="wwt-date-input-container">
          <input type="date" id="wwt-return-date" name="return_date" class="wwt-date-input" 
                min="<?php echo date('Y-m-d'); ?>" aria-label="Select return date" required>
          <span class="wwt-date-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 17H17V19H15V17Z" fill="#86B817"/>
              <path d="M11 17H13V19H11V17Z" fill="#86B817"/>
              <path d="M7 17H9V19H7V17Z" fill="#3182CE"/>
              <path d="M8 2V5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
              <path d="M16 2V5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
              <path d="M3.5 9.09H20.5" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
              <path d="M21 8.5V17C21 20 19.5 22 16 22H8C4.5 22 3 20 3 17V8.5C3 5.5 4.5 3.5 8 3.5H16C19.5 3.5 21 5.5 21 8.5Z" stroke="#86B817" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round"/>
    ...
    <div class="wwt-form-footer">
      <button type="submit" class="wwt-submit-btn" aria-label="Check availability">
        <span>Check Availability</span>
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="wwt-arrow-icon">
  ...
  <div class="container py-5">
      <div class="row g-5">
          ...
          <div class="col-lg-3 col-md-6">
              ...
              <a class="btn btn-link text-light" href="#" data-bs-toggle="modal" data-bs-target="#fujiModal">About Us</a>
              <a class="btn btn-link text-light" href="#" data-bs-toggle="modal" data-bs-target="#fujiModal">Contact Us</a>
              <a class="btn btn-link text-light" href="#" data-bs-toggle="modal" data-bs-target="#fujiModal">Our Services</a>
              <a class="btn btn-link text-light" href="#" data-bs-toggle="modal" data-bs-target="#fujiModal">Terms & Condition</a>
              <a class="btn btn-link text-light" href="#" data-bs-toggle="modal" data-bs-target="#fujiModal">Support</a>
          </div>
          
          <!-- Fuji Hadi Modal -->
          <div class="modal fade" id="fujiModal" tabindex="-1" aria-labelledby="fujiModalLabel" aria-hidden="true">
                  ...
                  <div class="modal-content bg-dark text-light">
                      ...
                      <div class="modal-body text-center">
                          <img src="logo/favicon.png"
                               alt="Fuji Hadi Hartanto" 
                               class="img-fluid rounded-circle mb-3" 
                               style="width: 150px; height: 150px; object-fit: cover;">
                          <h4>Web Developer & Designer</h4>
                          <p class="mb-3">Specializing in modern web solutions and creative design implementations.</p>
                          <div class="d-flex justify-content-center gap-3">
                              ...
                              <a href="mailto:fujihadi1997@gmail.com"
          ...
          <div class="col-lg-3 col-md-6">
              ...
              <div id="footerGallery" class="carousel slide" data-bs-ride="carousel">
                  ...
                  <button class="carousel-control-prev" type="button" data-bs-target="#footerGallery" data-bs-slide="prev">
                      <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                      <span class="visually-hidden">Previous</span>
                  </button>
                  <button class="carousel-control-next" type="button" data-bs-target="#footerGallery" data-bs-slide="next">
      ...
      <div class="copyright">
          <div class="row">
              <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                  &copy; <a class="border-bottom" href="#" data-bs-toggle="modal" data-bs-target="#portfolioModal">Fuji Hadi Hartanto</a>, All Right Reserved.
              </div>
  ...
  <div class="modal fade" id="portfolioModal" tabindex="-1" aria-labelledby="portfolioModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content bg-dark text-light">
              ...
              <div class="modal-body text-center">
                  <img src="https://dwidevelopes.github.io/portofolio-fuji-hadi-hartanto/assets/img/profile.jpg" alt="Profile" class="img-fluid rounded-circle mb-3" style="width: 150px;">
                  <h4>Web Developer Portfolio</h4>
                  <p>Visit my full portfolio to see my projects and skills.</p>
                  <a href="https://dwidevelopes.github.io/portofolio-fuji-hadi-hartanto/" class="btn btn-primary" target="_blank">View Portfolio</a>
              </div>
              <div class="modal-footer border-0 justify-content-center">
                  <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
              </div>
                  ...
                  <div class="accordion accordion-flush" id="faqAccordion">
                      ...
                      <div class="accordion-item bg-dark text-light">
                          ...
                          <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion">
                              <div class="accordion-body">
                                  All documentation is available in our Resources section under the Documentation tab.
                              </div>
                          </div>
                      </div>
                  </div>
